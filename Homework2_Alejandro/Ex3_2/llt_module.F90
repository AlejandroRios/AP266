...
contains
  ...
  subroutine induced_vel(Uinf, X1, X2, Xp, gamma_ind)
    ...
    ! Working variables
    real , dimension (3) :: r1v, r2v, n1, L_vtx, R_vtx, B_vtx, C1_L, C1_R, C1_B
  ...
  subroutine get_AIC_matrix(n_vort, X, Uinf, AIC)
    ...
    real , dimension (n_vort) :: r1v, r2v, n1, L_vtx, R_vtx, B_vtx, C1_L, C1_R, C1_B, X1ii,X1jj, X2jj, X2ii, gamma_ind, Xc
    real  :: r1, r2, C2_L, C2_R, C2_B,EPS,DEN
  ...
  subroutine tapenade_main(n_vort, X, Gama, alpha0, chords, cl0, cla, Vinf, rho, res, Sref, CL, CD, L, D)
    ...
    real :: Uai(3,n_vort), Uni(3,n_vort), si(3,n_vort)
    real :: areas(n_vort), Vlocal(3,n_vort), alphaLocal(n_vort)
    real :: Fcirc(3,n_vort), Fairf(3,n_vort), deltaF(3), Fbody(3), Fbodym, Vinfm
